      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu pedido llegará en 3-5 días laborables a tu punto de recogida
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿No es la talla adecuada? No te preocupes, cambiaremos tu
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Solo tienes que devolver tu producto y te reembolsaremos el
              dinero. Sin preguntas — haremos todo lo posible para que tu
              devolución sea sencilla.
            </p>
          </div>
        </div>
      </div>
