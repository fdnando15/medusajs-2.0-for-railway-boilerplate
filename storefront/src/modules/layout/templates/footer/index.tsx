...
export default async function Footer() {
  ...
  return (
    <footer className="w-full bg-[var(--muted)]">
      <div className="mx-auto max-w-6xl px-4 py-12 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/p/Sigrid-Bolsos-100068897574178/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/sigridbolsos/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[var(--muted-foreground)] hover:text-sigrid-accent transition-colors"
        ...
        <div className="mt-12 pt-6 border-t border-[var(--border)]">
          <p className="text-center text-sm text-[var(--muted-foreground)]">
            {currentYear} Sigrid. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
